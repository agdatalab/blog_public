...
이번 Post에서 사용하는 샘플 데이터는 수집 농가 1개소의 2015년 1년치의 데이터로 [Agdata Lab 저장소](https://github.com/igguniya/agdatalab_data)에서 다운로드할 수 있다. 측정 주기는 1분 단위이고 14개의 환경요소를 측정하여 기록한 데이터이다. 
...
<center> [NEXT : 스마트팜(ICT 기반 원예온실) 데이터의 이해 (2/2)](/post/smartfarm_data2) </center>
